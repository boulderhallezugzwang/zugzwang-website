// ═══════════════════════════════════════════════════════════════
// Hallendienst – Menü-Funktionen (gebundenes Script)
//
// Diesen Code im Spreadsheet einfügen:
//   Erweiterungen → Apps Script → neue Datei "HallendienstMenu"
//
// NICHT die doGet/doPost Funktionen — die bleiben im
// separaten Web-App Projekt.
// ═══════════════════════════════════════════════════════════════

var HD_SHEET_NAME = 'Hallendienst';
var HD_HEADERS = ['Datum', 'Status', 'Vorname', 'Nachname', 'E-Mail', 'Mobilnr'];
var HD_WOCHENTAGE = ['So', 'Mo', 'Di', 'Mi', 'Do', 'Fr', 'Sa'];

function onOpen() {
  SpreadsheetApp.getUi()
    .createMenu('Hallendienst')
...
function hdGenerateRange(vonISO, bisISO) {
  ...
  // Bestehende Daten laden um Duplikate zu vermeiden
  var existing = {};
